...
function CreateGame(props) {
    ...
    const saveGame = (e) => {
        setShowLoading(true);
        e.preventDefault();
        const data = {title: game.title, content: game.content, username: username };
        //
        ...
        {showLoading && 
            ...
            <Form onSubmit={saveArticle}>
              ...
              <Form.Group>
                ...
                <Form.Control as="textarea" rows="3" name="content" id="content" placeholder="Enter Content" value={game.content} onChange={onChange} />
              </Form.Group>
